	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf':
				...
				addOffset("singRIGHT", -80, -2);
				addOffset("singLEFT", -10, -13);
				addOffset("singDOWN", -2, -44);
				addOffset("singUPmiss", -60, 50);
				addOffset("singRIGHTmiss", -80, -2);
				addOffset("singLEFTmiss", -10, -13);
				addOffset("singDOWNmiss", -2, -44);
				addOffset("hey", -2, 0);
				addOffset('firstDeath');
				addOffset('deathLoop', 0, -13);
				addOffset('deathConfirm', 0, -6);
				addOffset('scared', -13, 0);
